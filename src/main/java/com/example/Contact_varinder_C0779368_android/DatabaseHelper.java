...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    boolean addPerson(String firstName,String lastName ,String phone , String address,String email){
    ...
    boolean updatePerson(int id,String first_name, String last_name, String phone, String address,String email){
        SQLiteDatabase sqLiteDatabase = getWritableDatabase();
